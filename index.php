...
<div id="wrapper">
  ...
  <div class="wrapper-mid">
    ...
    <?php
        ...
        $cvQuery = "SELECT * FROM `basic_information` order by 1 DESC";

        $runQuery = mysqli_query($con,$cvQuery);
    ...
    <div id="paper">
      ...
      <div id="paper-mid">
        <div class="entry">
          <!-- Begin Image -->
          <img class="portrait" src="admin/images/<?php echo $photo; ?>" alt="images/<?php echo $photo; ?>" />
          <!-- End Image -->
      ...
      <?php } ?>
        ...
        $cvQuery = "SELECT * FROM `experience` order by 1 DESC";
